...
import planeModel from 'assets/perfume_bottle.glb';
...
export default function Plane({ canvasHeight, ...props }) {
    ...
    useEffect(() => {
        ...
        cameraRef.current.position.z = 111;
        ...
        const ambientLight = new AmbientLight(0xFFFFFF, 0.88);
        ...
        loader.load(planeModel, gltf => {
            ...
            modelRef.current.position.y = -30;
